...
func NewMagicMap_10_4() MagicMap {
	mm := new(magicMap_10_4)
	return mm
}

type magicMap_10_4 struct { // capa is 4096 in/64 out
...
func (mm magicMap_10_4) Get(key uint64) (value uint64) {
	const maxin = 1 << 10
	if key == 0 {
		return 0
	}
...
func (mm magicMap_10_4) Size() (bytes int) {
	return int(unsafe.Sizeof((mm)))
}

func (mm magicMap_10_4) Count() (in, out int) {
	return int(mm.nbin), int(mm.nbout)
}

func (mm magicMap_10_4) Capa() (in, out int) {
	return 1<<10, 1 << 4
}

func (mm *magicMap_10_4) Set(key, value uint64) {
	const maxin = 1 << 10
	const maxout = 1 << 4
...
func (mm magicMap_10_4) AllKeys() []uint64 {
...
func (mm magicMap_10_4) AllValues() (values []uint64) {
	return append(values, mm.values[:mm.nbout]...)
}

func (mm magicMap_10_4) Dump() {

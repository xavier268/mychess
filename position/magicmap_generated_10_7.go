...
// Generated on 2025-02-27 18:04:40.8356001 +0100 CET m=+0.031403601
// Input : 10 bits (up to 1024 keys) -> Output : 7 bits (up to 128 values)
...
func NewMagicMap_10_7() MagicMap {
	mm := new(magicMap_10_7)
	mm.magic = defaultmagic
	return mm
}

type magicMap_10_7 struct { // capa is 4096 in/64 out
...
func (mm *magicMap_10_7) SetMagic(magic uint64) (MagicMap){
	if magic == 0 {
...
func (mm magicMap_10_7) Get(key uint64) (value uint64) {
...
func (mm magicMap_10_7) Size() (bytes int) {
	return int(unsafe.Sizeof((mm)))
}

func (mm magicMap_10_7) Count() (in, out int) {
	return int(mm.nbin), int(mm.nbout)
}

func (mm magicMap_10_7) Capa() (in, out int) {
	return 1<<10, 1 << 7
}

func (mm *magicMap_10_7) Set(key, value uint64) {
	const maxin = 1 << 10
	const maxout = 1 << 7
...
func (mm magicMap_10_7) AllKeys() []uint64 {
...
func (mm magicMap_10_7) AllValues() (values []uint64) {
	return append(values, mm.values[:mm.nbout]...)
}


func (mm magicMap_10_7) Dump() {

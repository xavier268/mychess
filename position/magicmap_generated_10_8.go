...
// Generated on 2025-02-27 18:02:06.2661012 +0100 CET m=+0.031471101
// Input : 10 bits (up to 1024 keys) -> Output : 8 bits (up to 256 values)
...
func NewMagicMap_10_8() MagicMap {
	mm := new(magicMap_10_8)
	mm.magic = defaultmagic
	return mm
}

type magicMap_10_8 struct { // capa is 4096 in/64 out
...
func (mm magicMap_10_8) Get(key uint64) (value uint64) {
...
func (mm magicMap_10_8) Size() (bytes int) {
	return int(unsafe.Sizeof((mm)))
}

func (mm magicMap_10_8) Count() (in, out int) {
	return int(mm.nbin), int(mm.nbout)
}

func (mm magicMap_10_8) Capa() (in, out int) {
	return 1<<10, 1 << 8
}

func (mm *magicMap_10_8) Set(key, value uint64) {
	const maxin = 1 << 10
	const maxout = 1 << 8
...
func (mm magicMap_10_8) AllKeys() []uint64 {
...
func (mm magicMap_10_8) AllValues() (values []uint64) {
	return append(values, mm.values[:mm.nbout]...)
}


func (mm magicMap_10_8) Dump() {
...
func (mm magicMap_10_8)  hash(key uint64) uint16 {
	return uint16((key * mm.magic) >> 24) & (1<<10-1) // middle bits have the most entropy
}

// Analyse the collisions in this map
func (mm magicMap_10_8) Stats() (st MagicStats) {

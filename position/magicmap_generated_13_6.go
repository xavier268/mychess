...
// Generated on 2025-02-27 18:04:40.8041962 +0100 CET m=+0.000000001
// Input : 13 bits (up to 8192 keys) -> Output : 6 bits (up to 64 values)
...
func NewMagicMap_13_6() MagicMap {
	mm := new(magicMap_13_6)
	mm.magic = defaultmagic
	return mm
}

type magicMap_13_6 struct { // capa is 4096 in/64 out
	zerovalue uint64           // value for the '0' key
	keys   [1<<13]uint64 // keyindex ->  input keys
	index  [1<<13]uint8  // keyindex -> valueindex ( NOTE : assumes index < 256 for up to 256 distict output values per magicmap).
...
func (mm *magicMap_13_6) SetMagic(magic uint64) (MagicMap){
	if magic == 0 {
...
func (mm magicMap_13_6) Get(key uint64) (value uint64) {
...
func (mm magicMap_13_6) Size() (bytes int) {
	return int(unsafe.Sizeof((mm)))
}

func (mm magicMap_13_6) Count() (in, out int) {
	return int(mm.nbin), int(mm.nbout)
}

func (mm magicMap_13_6) Capa() (in, out int) {
	return 1<<13, 1 << 6
}

func (mm *magicMap_13_6) Set(key, value uint64) {
	const maxin = 1 << 13
	const maxout = 1 << 6
...
func (mm magicMap_13_6) AllKeys() []uint64 {
...
func (mm magicMap_13_6) AllValues() (values []uint64) {
	return append(values, mm.values[:mm.nbout]...)
}


func (mm magicMap_13_6) Dump() {
...
func (mm magicMap_13_6)  hash(key uint64) uint16 {
	return uint16((key * mm.magic) >> 24) & (1<<13-1) // middle bits have the most entropy
}

// Analyse the collisions in this map
func (mm magicMap_13_6) Stats() (st MagicStats) {

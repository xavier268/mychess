...
// Generated on 2025-02-27 21:30:42.0687252 +0100 CET m=+0.032861901
...
func (mm *magicMap_5_4) SetMagic(magic uint64) (MagicMap){
	if magic == 0 {
...
func (mm magicMap_5_4)  hash(key uint64) uint16 {
	return uint16((key * mm.magic) >> 24) & (1<<5-1) // middle bits have the most entropy
}

// Analyse the collisions in this map
func (mm magicMap_5_4) Stats() (st MagicStats) {
